...
def generate_launch_description():
    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[
                {"robot_id": robot_id_1,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            package='patrol_robot',
            namespace=robot_id_6,
            executable='patrol_robot_node',
            name=robot_id_6 + '_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_1 + '_node' + ' -e',
        ...
        Node(
            ...
            namespace=robot_id_6,
            executable='patrol_comsim_node',
            name=robot_id_6 + '_com_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_6 + '_com_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_6,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            package='patrol_robot',
            namespace=robot_id_7,
            executable='patrol_robot_node',
            name=robot_id_7 + '_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_7 + '_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_7,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            ...
            namespace=robot_id_7,
            executable='patrol_comsim_node',
            name=robot_id_7 + '_com_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_7 + '_com_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_7,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            package='patrol_robot',
            namespace=robot_id_8,
            executable='patrol_robot_node',
            name=robot_id_8 + '_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_8 + '_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_8,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            ...
            namespace=robot_id_8,
            executable='patrol_comsim_node',
            name=robot_id_8 + '_com_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_8 + '_com_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_8,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            package='patrol_robot',
            namespace=robot_id_9,
            executable='patrol_robot_node',
            name=robot_id_9 + '_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_9 + '_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_9,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            ...
            namespace=robot_id_9,
            executable='patrol_comsim_node',
            name=robot_id_9 + '_com_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_9 + '_com_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_9,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
        ...
        Node(
            package='patrol_robot',
            namespace=robot_id_10,
            executable='patrol_robot_node',
            name=robot_id_10 + '_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_10 + '_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_10,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
                 "mission_spec_file_path": "mission_spec_inst_5r_20w_01.json",
                 "inst_id": inst_id}
        ...
        Node(
            ...
            namespace=robot_id_10,
            executable='patrol_comsim_node',
            name=robot_id_10 + '_com_node',
            output="screen",
            emulate_tty=True,
            # to open the node in another term
            prefix='xterm -T ' + robot_id_10 + '_com_node' + ' -e',
            parameters=[
                {"robot_id": robot_id_10,
                 "team_members_file_name": "team_spec_inst_10r_20w.json",
                 "robots_spec_file_name": "robots_spec_inst_10r_20w_01.json",
