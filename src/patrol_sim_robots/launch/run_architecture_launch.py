...
def generate_launch_description():
    ...
    config_sim = Path(get_package_share_directory('patrol_sim_robots'), 'config', 'params.yaml')
    # config_interface = Path(get_package_share_directory('patrol_interface'), 'config', 'params.yaml')
